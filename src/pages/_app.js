...
export default function App({ Component, pageProps }) {
  return (
    <>
      <Head>
        <title>Biggy Index</title>
        <meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover" />
        <meta name="description" content="LB Index — a lightweight searchable catalog." />
        <meta charSet="utf-8" />
        ...
        <meta property="og:description" content="LB Index — a lightweight searchable catalog." />
