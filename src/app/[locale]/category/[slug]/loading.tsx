 ...
 *
 * Mirrors /item/[ref]/loading.tsx deliberately: item/[ref] is the ONLY param
 * route whose runtime renders stay storable in prod, and the presence of a
 * route-level Suspense boundary is the sole structural difference from
 * seller/category (2026-07 caching investigation). Kept in lockstep with the
