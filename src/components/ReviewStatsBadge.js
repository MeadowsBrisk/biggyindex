...
export default function ReviewStatsBadge({ reviewStats }) {
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-baseline gap-1 flex-wrap">
                      <span className="font-semibold text-gray-900 dark:text-gray-100 text-[13px]">Reviews</span>
                      <span className="text-gray-500 dark:text-gray-400 truncate">snapshot</span>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-bold text-gray-900 dark:text-gray-100 leading-none">{rating.toFixed(1)}</div>
                    <div className="text-[11px] text-gray-500 dark:text-gray-400 leading-none">out of 10</div>
                  </div>
                </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {(() => {
                      if (typeof avgDays === "number") {
                        ...
                        const label = `${rounded} day${rounded === 1 ? '' : 's'}`;
