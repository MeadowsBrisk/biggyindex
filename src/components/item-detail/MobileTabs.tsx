...
type Props = {
  ...
  setIncludeShipping: React.Dispatch<React.SetStateAction<boolean>>;
  shippingOptions: any[];
  allShippingFree: boolean;
  selectedShipIdx: number | null | undefined;
  setSelectedShipIdx: (idx: number) => void;
  variantPriceRangeText?: string;
  perUnitSuffix?: (...args: any[]) => any;
  reviews: any[];
  loading: boolean;
  error: any;
  reload: () => void;
  fullTimeAgo: any;
  onReviewImageClick: (images: string[], index: number) => void;
  description?: string | null;
  convertToGBP: (...args: any[]) => number | null;
  roundDisplayGBP?: any;
