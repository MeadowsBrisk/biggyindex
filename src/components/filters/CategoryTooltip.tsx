...
interface CategoryTooltipProps {
  categoryName: string;
  subcategories?: SubcategoryRecord | null;
  children: ReactNode;
}
...
/**
 * Tooltip that shows subcategories with counts on hover.
 */
export default function CategoryTooltip({ categoryName, subcategories, children }: CategoryTooltipProps) {
  ...
  const updatePosition = useCallback((e: MouseEvent | null) => {
