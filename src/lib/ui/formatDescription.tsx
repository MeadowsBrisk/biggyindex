...
export default function formatDescription(raw?: string | null): React.ReactElement | null {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // Default paragraph line: merge consecutive plain lines into one paragraph unless blank lines separate them
    let para = line;
