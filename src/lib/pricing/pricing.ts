...
export function computeUsdListGBPRange(values: Array<number | null | undefined>, rates: Record<string, number> | null | undefined) {
...
export function formatUsdShippingRange(minShip: number | null | undefined, maxShip: number | null | undefined, rates: Record<string, number> | null | undefined, { freeLabel='free' }: { freeLabel?: string } = {}) {
  ...
  const { min, max, ready } = computeUsdListGBPRange(values, rates as any);
  if (!ready) {
