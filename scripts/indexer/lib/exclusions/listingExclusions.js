...
// Separated from index-items.js for modularity. Behaviour must remain identical.

function isTipListing(name, description) {
...
function isCustomListing(name, description) {
...
module.exports = { isTipListing, isCustomListing };
