// Phase 1 extracted taxonomy (no behavioural changes). Exported for reuse.
// NOTE: Keep this in sync with original monolith until full rule modularization.
...
const TAXONOMY = {
  ...
  Shake: ["shake", "trim", "popcorn", "sugar leaf", "sugarleaf"],
      PreRolls: [
        ...
        "hand rolled", "hand-rolled", "cone", "cones", "stick", "sticks"
      ],
      ...
      Landrace: [
        "landrace", "landraces", "thai stick", "thai sticks", "red string", "brick", "brick weed", "ital"
      ],
      Exotics: [
        "exotic", "exotics"
      ],
      // New: Smalls / clearance style
      Smalls: [
        "smalls", "small nugs", "smaller nugs", "neglected nugs", "spares", "clearance"
      ]
    }
  },
  Hash: {
  ...
  Tincture: {
    keywords: [
      'tincture', 'tinctures', 'sublingual', 'oral spray', 'sublingual spray',
      'spray tincture', 'tincture spray', 'live resin tincture', 'resin spray', 'oral', 'fast acting'
    ],
    children: {
  ...
  Vapes: {
    keywords: [
      "vape", "vapes", "disposable", "disposables", "carts", "cart", "cartridge", "cartridges", "thc liquid", "device", "pod", "pen", "pens",
      "d9", "delta 9", "delta-9", "delta9", "live resin", "battery", "510", "510 thread"
    ],
    children: {
